...
const contactApi = {
	...
	updateContactAuthor: async (data) => {
		return await apiClient.post('private/contact/update-author', data);
	},
	updateStatus: async (data) => {
		return await apiClient.post('private/contact/update-status', data);
	},
